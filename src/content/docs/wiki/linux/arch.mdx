...
# Enter passphrase and do not forget it, or your data will be unacessible
```
...
Add the NTP pools to your `etc/systemd/tymesyncd.conf`:
...
This is always changing with NVIDIA drivers, so check compatability in the [wiki](https://wiki.archlinux.org/title/NVIDIA).
